...
This is the human handoff for getting paid if the Midnight issue #314 submission is selected.
...
The bounty is a Tier 3 Deep task, listed as `$700-$1,000` in NIGHT tokens. The terms say payout happens after approval and KYC, and the best valid submission may be selected rather than every submission.
