...
- Compact contract based on the Midnight bulletin board scaffold
- TypeScript witness/API packages
- React UI with a metadata/status panel
- Node metadata API with health and campaign endpoints
